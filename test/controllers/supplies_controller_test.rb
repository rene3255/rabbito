...
class SuppliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supply" do
    assert_difference("Supply.count") do
      post supplies_url, params: { supply: { acquisition_date: @supply.acquisition_date, cost: @supply.cost, description: @supply.description, quantity: @supply.quantity } }
    end
  ...
  test "should update supply" do
    patch supply_url(@supply), params: { supply: { acquisition_date: @supply.acquisition_date, cost: @supply.cost, description: @supply.description, quantity: @supply.quantity } }
